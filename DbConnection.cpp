...
void DbConnection::AddCharacteristicTypes(QList<CharacteristicTypeContext*> characteristicTypes)
{
...
bool DbConnection::AddCharacteristicType(CharacteristicTypeContext* characteristicType, bool isComplex)
{
